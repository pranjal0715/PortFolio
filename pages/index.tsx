...
export default function Home() {
  let title = "About Me",
    description =
      "From a non-CS background, I transitioned into tech in 2022 as a software engineer. Now a full-stack developer, I build impactful digital solutions using modern technologies, driven by curiosity, problem-solving, and a commitment to continuous learning.";
  return (
    <main>
      <div className="active-dark">
        ...
        >
          <Image
            src="/assets/images/bg/portrait.png"
            fill
            style={{
          ...
          >
            <div className="inner text-left">
              ...
              <h1 className="title header__hero--heading">
                ...
                <span>the Future of Web</span> <br />
                <span className="header__hero--heading-gradient">
                  Fullstack Developer
                </span>
                <br />
                {/* <span>Crafting Seamless Experiences & Robust Solutions</span> */}
              </h1>
